...
Check your Version [Hardware](https://www.ibm.com/support/knowledgecenter/en/SS5R93_5.3.4/com.ibm.spectrum.sc.doc/fqz0_r_hw_requirements.html)
and [Software](https://www.ibm.com/support/knowledgecenter/en/SS5R93_5.3.4/com.ibm.spectrum.sc.doc/fqz0_r_sw_requirements.html)
...
### Example 2: Install SC with IBM DB2 Role      
    ...
    - hosts: sc
      ...
      vars:
        ...
        db2_binary:
          url: "http://10.10.10.56/sc/SC534/DB2_AWSESRU_F_LIN_V11.1.4_F_SC.tar.gz"
          location: "/download/installer/db2_11.1.4.tar.gz"
          dest: "/download/installer"
        db2_license_binary:
          url: "http://10.10.10.56/sc/SC534/DB2_AWSE_Restricted_Activation_11.1.zip"
        ...
        ## For the Spectrum Scale DB2 binary package it uses 'server_t'
        ## For the Spectrum Scale DB2 License package it uses 'awse_o'
        ##
...
#### Example 4: - Most rich example with all of variables and IBM DB2 and Spectrum Control installer.
    ...
    - hosts: sc
      ...
      vars:
        ...
        ##
        db2_binary:
          url: "http://10.33.3.56/sc/SC534/DB2_AWSESRU_F_LIN_V11.1.4_F_SC.tar.gz"
          location: "/download/installer/db2_11.1.4.tar.gz"
          dest: "/download/installer"
        db2_license_binary:
          url: "http://10.33.3.56/sc/SC534/DB2_AWSE_Restricted_Activation_11.1.zip"
          location: "/download/installer/db2_license.tar.gz"
          dest: "/download/installer"
        ##
        ## On most DB2 compressed binary the tar.gz creates a file named server, but if your compressed file doesn't,
